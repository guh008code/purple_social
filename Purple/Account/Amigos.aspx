<%@ Page Title="Purple Social Science - Amigos" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Amigos.aspx.cs" Inherits="Amigos" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <div class="accountFoto divFlutuantesEsquerda">
         ...
         <div class="accountFoto divFlutuantesEsquerda">
         <fieldset id="dvPendentes" runat="server" visible="false" class="register fieldsetPortalPostagem">
          <legend>Amizades Pendentes <%=nome %></legend>
            <asp:Literal ID="ltrAmigosPendetes" runat="server"></asp:Literal>
          </fieldset>

            <fieldset class="register fieldsetPortalPostagem">
                <legend>Amizades <%=nome %></legend>
